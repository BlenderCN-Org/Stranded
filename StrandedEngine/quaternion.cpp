...
/*
 * 四元组乘法
 * 不可互换，不能将该四元组的每个分量乘上两一个四元组的对应分量
 * 计算公式:
...
/*
 * 旋转
 * 无需矩阵旋转四元组，并从该四元组创建矩阵
 * 该矩阵可将四元组转换成Direct3D OpenGL可用的形式
 */
void CQuaternion::Rotatef(float amount, float xAxis, float yAxis, float zAxis)
{
